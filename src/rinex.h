...
public:
  ...
  bool setSatListElement(SatObsAtEpoch input, unsigned short numObsTypes,
                         int i);
...
protected:
  ...
  bool validYMDHMS(long year, long month, long day, long hour, long minute,
                   double second, string &warningString);
};
