...
// Selectors
DateTime ObsEpoch::getEpochTime() { return epochTime; }

unsigned short ObsEpoch::getEpochFlag() { return epochFlag; }

unsigned short ObsEpoch::getNumSat() { return numSat; }

SatObsAtEpoch ObsEpoch::getSatListElement(int i) { return satList[i]; }

double ObsEpoch::getRecClockOffset() { return recClockOffset; }

string ObsEpoch::getEpochHeaderRecords() { return epochHeaderRecords; }
...
// Selectors
DateTime MetEpoch::getEpochTime() { return epochTime; }

MetSet MetEpoch::getMetListElement(int i) { return metList[i]; }
...
// Selectors
CLKTYPE ClkEpoch::getClockDataType() { return clockDataType; }

string ClkEpoch::getRecvrSatName() { return recvrSatName; }

DateTime ClkEpoch::getEpochTime() { return epochTime; }

unsigned short ClkEpoch::getNumberDataValues() { return numberDataValues; }

double ClkEpoch::getClockBias() { return clockBias; }

double ClkEpoch::getClockBiasSigma() { return clockBiasSigma; }

double ClkEpoch::getClockRate() { return clockRate; }

double ClkEpoch::getClockRateSigma() { return clockRateSigma; }

double ClkEpoch::getClockAcceleration() { return clockAcceleration; }

double ClkEpoch::getClockAccelSigma() { return clockAccelSigma; }
...
unsigned short GlonassEphemEpoch::getEpochYear() { return epochYear; }
unsigned short GlonassEphemEpoch::getEpochMonth() { return epochMonth; }
unsigned short GlonassEphemEpoch::getEpochDay() { return epochDay; }
unsigned short GlonassEphemEpoch::getEpochHour() { return epochHour; }
unsigned short GlonassEphemEpoch::getEpochMin() { return epochMin; }
double GlonassEphemEpoch::getEpochSec() { return epochSec; }
...
unsigned short GeostationaryEphemEpoch::getEpochYear() { return epochYear; }
unsigned short GeostationaryEphemEpoch::getEpochMonth() { return epochMonth; }
unsigned short GeostationaryEphemEpoch::getEpochDay() { return epochDay; }
unsigned short GeostationaryEphemEpoch::getEpochHour() { return epochHour; }
unsigned short GeostationaryEphemEpoch::getEpochMin() { return epochMin; }
double GeostationaryEphemEpoch::getEpochSec() { return epochSec; }
...
void HeaderRecord::SetFirst60(string input) { first60 = input.substr(0, 60); }

void HeaderRecord::SetLabel(string input) { label = input.substr(0, 20); }

string HeaderRecord::GetFirst60() { return (first60); }

string HeaderRecord::GetLabel() { return (label); }
...
HeaderRecord *HeaderRecord::operator&(HeaderRecord input) { return &input; }
...
// Selectors
string RinexFile::getPathFilename() { return (pathFilename); }

ios::openmode RinexFile::getFileMode() { return (fileMode); }

RinexHeader RinexFile::getRinexHeaderImage() { return (rinexHeaderImage); }
...
string RinexFile::getErrorMessages() { return (errorMessages.str()); }

string RinexFile::getWarningMessages() { return (warningMessages.str()); }
...
// Destructor
RinexObsFile::~RinexObsFile() { --numberObsFiles; }
...
bool RinexObsFile::validHeaderRecord(string inputRec) {
  ...
  if (inputRec.find("COMMENT") == 60) {
    ...
    if (!validYMDHMS(firstObs.year, firstObs.month, firstObs.day, firstObs.hour,
    ...
    if (!validYMDHMS(lastObs.year, lastObs.month, lastObs.day, lastObs.hour,
                     lastObs.min, lastObs.sec, warningString)) {
      tempStream << "On line #" << getNumberLinesRead() << ":" << endl
                 << inputRec << endl
...
bool RinexObsFile::validEventFlagRecord(string inputRec) {
  ...
  if (!blankString(cols2thru26)) {
    ...
    if (getDouble(temp, tempD))
      ymdhms.sec = tempD;
    if (!validYMDHMS(ymdhms.year, ymdhms.month, ymdhms.day, ymdhms.hour,
                     ymdhms.min, ymdhms.sec, warningString)) {
      tempStream << " On line #" << getNumberLinesRead() << ":" << endl
                 << inputRec << endl
                 << warningString << endl;
      appendToWarningMessages(tempStream.str());
...
void RinexObsFile::writeEpoch(ofstream &outputOBS, ObsEpoch &outputEpoch) {
  ...
  } else if (outputEpoch.getEpochFlag() >= 2 &&
             outputEpoch.getEpochFlag() <= 5) {
...
unsigned short RinexObsFile::getNumWaveLenPRN() { return numWaveLenPRN; }
...
string RinexObsFile::getFirstObsTimeSystem() { return firstObsTimeSystem; }
YMDHMS RinexObsFile::getLastObs() { return lastObs; }
string RinexObsFile::getLastObsTimeSystem() { return lastObsTimeSystem; }
...
unsigned int RinexObsFile::getNumberObsEpochs() { return (numberObsEpochs); }

unsigned int RinexObsFile::getObsFilesCount() { return (numberObsFiles); }
...
// Destructor
RinexNavFile::~RinexNavFile() { --numberNavFiles; }
...
unsigned int RinexNavFile::getNumberPRNBlocks() { return (numberPRNBlocks); }

unsigned int RinexNavFile::getNavFilesCount() { return (numberNavFiles); }
...
// Destructor
GlonassNavFile::~GlonassNavFile() { --numberFiles; }
...
// Selectors
unsigned short GlonassNavFile::getRefTimeYear() { return refTimeYear; }
unsigned short GlonassNavFile::getRefTimeMonth() { return refTimeMonth; }
unsigned short GlonassNavFile::getRefTimeDay() { return refTimeDay; }
double GlonassNavFile::getTimeScaleCorr() { return timeScaleCorr; }
unsigned short GlonassNavFile::getLeapSec() { return leapSec; }
...
unsigned int GlonassNavFile::getNumberEpochs() { return (numberEpochs); }

unsigned int GlonassNavFile::getFilesCount() { return (numberFiles); }
...
// Destructor
GeostationaryNavFile::~GeostationaryNavFile() { --numberFiles; }
...
unsigned short
GeostationaryNavFile::readEphemEpoch(GeostationaryEphemEpoch &navEpoch) {
  unsigned short tempUS, tyear;
  string inputRec;
  size_t l;
  string temp;
...
// Selectors
unsigned short GeostationaryNavFile::getRefTimeYear() { return refTimeYear; }
unsigned short GeostationaryNavFile::getRefTimeMonth() { return refTimeMonth; }
unsigned short GeostationaryNavFile::getRefTimeDay() { return refTimeDay; }
double GeostationaryNavFile::getCorrToUTC() { return corrToUTC; }
unsigned short GeostationaryNavFile::getLeapSec() { return leapSec; }
...
unsigned int GeostationaryNavFile::getNumberEpochs() { return (numberEpochs); }
...
// Destructor
RinexMetFile::~RinexMetFile() { --numberMetFiles; }
...
// Selectors
string RinexMetFile::getMarkerName() { return markerName; }
string RinexMetFile::getMarkerNumber() { return markerNumber; }
unsigned short RinexMetFile::getNumMetTypes() { return numMetTypes; }
...
unsigned int RinexMetFile::getNumberMetEpochs() { return (numberMetEpochs); }

unsigned int RinexMetFile::getMetFilesCount() { return (numberMetFiles); }
...
// Destructor
ClockDataFile::~ClockDataFile() { --numberClkFiles; }
...
// Selectors
unsigned short ClockDataFile::getLeapSec() { return leapSec; }
unsigned short ClockDataFile::getNumberClkTypes() { return numberClkTypes; }
enum CLKTYPE ClockDataFile::getClkTypeListElement(int i) {
  return clkTypeList[i];
}
string ClockDataFile::getStationName() { return stationName; }
string ClockDataFile::getStationNumber() { return stationNumber; }
string ClockDataFile::getStationClkRef() { return stationClkRef; }
string ClockDataFile::getACDesignator() { return ACDesignator; }
string ClockDataFile::getAnalysisCenterName() { return analysisCenterName; }

unsigned short ClockDataFile::getNumberAnalysisClockRef() {
  return numberAnalysisClkRef;
}
DateTime ClockDataFile::getAnalysisStartEpoch() { return analysisStartEpoch; }
DateTime ClockDataFile::getAnalysisStopEpoch() { return analysisStopEpoch; }
unsigned short ClockDataFile::getNumberSolnSta() { return numberSolnSta; }
string ClockDataFile::getTerrRefFrameOrSinex() { return terrRefFrameOrSinex; }
...
string ClockDataFile::getPrnListElement(int i) { return prnList[i]; }
...
unsigned short ClockDataFile::getNumberClkEpochs() { return (numberClkEpochs); }

unsigned short ClockDataFile::getClkFilesCount() { return (numberClkFiles); }
...
string RequiredRecordMissingException::getMessage() { return (ErrorMessage); }
...
string RinexFileException::getMessage() { return (ErrorMessage); }
...
string RinexReadingException::getMessage() { return (ErrorMessage); }
