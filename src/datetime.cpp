...
DateTime::DateTime(long year, long month, long day, long hour, long min,
                   double sec) {
  long doy;
...
void DateTime::SetGPSTime(GPSTime gpstime2) { *this = DateTime(gpstime2); }

void DateTime::SetMJD(MJD inputMJD) { *this = DateTime(inputMJD); }

void DateTime::SetYDOYHMS(YDOYHMS yearDoyHMS) { *this = DateTime(yearDoyHMS); }

void DateTime::SetYMDHMS(YMDHMS yearMonthDayHMS) {
  *this = DateTime(yearMonthDayHMS);
}

void DateTime::SetYMDHMS(long year, long month, long monthday, long hour,
                         long min, double sec) {
...
DateTime *DateTime::operator&(DateTime input) { return &input; }
